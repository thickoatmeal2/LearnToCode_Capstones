...
javac src/com/pluralsight/*.java



Run:

java -cp src com.pluralsight.Main
...
Select R, then 5 (Search by Vendor):
...
ls -l /path/to/your-project/transactions.csv

Should show rw for user.



If path is incorrect (e.g., out/), update Main.java:

private static final File CSV_FILE_PATH = new File("/path/to/your-project/transactions.csv");
